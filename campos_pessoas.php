...
<input type="password" name="cpf" maxlength="14"/></fieldset><br>
<fieldset><font color="white"><label>Site Preferido :</label></font>
...
<label>Feminino</label></fieldset>
<br><fieldset>
<input type="checkbox" name="aceito" value="true" />
<label>Aceito Contrato</label></fieldset>
<br><fieldset>  
<select name="estado">
